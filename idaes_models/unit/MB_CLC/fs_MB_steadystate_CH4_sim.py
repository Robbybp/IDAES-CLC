...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 29 09:16:42 2019
...
import MB_steadystate_FR as MB_CLC_fuel
...
#        fe_set = [0, 0.004]
        fe_set = [0, 0.0005, 0.001, 0.002, 0.004, 0.008, 0.012, 0.016]
        for i in range(1,nfe+1):
            if i < nfe*fe_a:
                fe_set.append(i*fe_b/(nfe*fe_a))
            elif i == nfe:   
#                fe_set.append(0.9852)
#                fe_set.append(0.9862)
#                fe_set.append(0.9872)
#                fe_set.append(0.9882)
#                fe_set.append(0.9892)
#                fe_set.append(0.9902)
#                fe_set.append(0.9912)
#                fe_set.append(0.9925)
#                fe_set.append(0.9937)
#                fe_set.append(0.995)
#                fe_set.append(0.9962)
#                fe_set.append(0.9975)
#                fe_set.append(0.9987)
                fe_set.append(1)
            else:
...
def setInputs(fs):    
    ...
    fs.MB_fuel.Gas_In_P.fix(1.37)   # bar *estimated. min pressure to overcome pressure drop
    fs.MB_fuel.Gas_In_Tg.fix(873.15)     # K
    ...
    fs.MB_fuel.Solid_In_x['Fe2O3'].fix(0.449)
    fs.MB_fuel.Solid_In_x['Fe3O4'].fix(0.001)
...
def print_summary_fuel_reactor(fs):
    ...
    print("\nGas inlet velocity: ", value(fs.MB_fuel.vgz[0]), "m/s")
    print("Gas outlet velocity: ", value(fs.MB_fuel.vgz[1]), "m/s")
    ...
    print("Fe2O3 conversion: ", value(fs.MB_fuel.X_Fe2O3)*100, " %")
...
#    plt.plot(self.MB_fuel.z, Tw, label='Tw')
    ...
    umf = []
    for z in self.MB_fuel.z:
        vgz.append(value(self.MB_fuel.vgz[z]))
        umf.append(value(self.MB_fuel.umf[z]))
    fig_vgz = plt.figure(3)
    plt.plot(self.MB_fuel.z, vgz, label='vg')
